    ...
    <div className='main-body'>
        ...
        <div className='container80'>
            <div className='content-wrapper'>
                ...
                <li>
                <p><strong>Website</strong> refers to Full Stack Web Developer - Warren Chen, accessible from <a href="https://wchen.im" rel="external nofollow noopener">https://wchen.im</a></p>
                </li>
                <li>
